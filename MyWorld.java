...
public class MyWorld extends World
{
    ...
    public void Monster ()
    {
         monster++;
        if (monster==877){
              Monster monsterku = new Monster();
       GreenfootImage image = monsterku.getImage();
       addObject(monsterku , getWidth(), getHeight()/2); 
       monster = 0;
      }
    }
    public void Tong ()
    {
        ...
        if (tong==150){
              ...
              addObject(tongku , getWidth(), getHeight()/1-80 + image.getHeight()/1-80);       
    ...
    public void Track ()
    {
        ...
        if (track==50){
              ...
              addObject(jalanku , getWidth(), getHeight()/1-75 + image.getHeight()/1-75);       
       //System.out.println(counter);
        track = 0;
      }
    }
